                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row contact">
                                            <div class="col-lg-12 ">
                                                ...
                                                <div class="d-flex align-items-center mt-1">
                                                    <label for="password" class="form-label pe-2" style="color: #fff;font-size:15px; font-weight:bold;">Password: </label>
                                                    <input type="text" class="form-control password-input" placeholder="Enter Password..." id="password" required>
                                                </div>
                                            </div>
                                        </div>
